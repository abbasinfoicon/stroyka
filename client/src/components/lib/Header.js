...
import UserMenu2 from '../blocks/UserMenu2'
                                ...
                                <div className="nav-panel__row">
                                    <div className="nav-panel__departments">
                                        <div className="departments"
                                            data-departments-fixed-by=".block-slideshow"> {/* departments--open departments--fixed */}
                                    ...
                                    <div className="nav-panel__indicators">
                                        <div className="indicator">
                                            <Link to='/' className="indicator__button">
                                                <span className="indicator__area">
                                                    <svg width="20px" height="20px">
                                                        <use xlinkHref="assets/images/sprite.svg#heart-20"></use>
                                                    </svg>
                                        ...
                                        <div className="indicator indicator--trigger--click">
                                            <Link to='/' className="indicator__button">
                                                <span className="indicator__area">
                                                    <svg width="20px"
                                                        height="20px">
                                                        <use xlinkHref="assets/images/sprite.svg#person-20"></use>
                                                    </svg>
                                                </span>
                                            </Link>
